...
use App\Controller\Admin\DepositsController;
use Cake\TestSuite\IntegrationTestTrait;
use Cake\TestSuite\TestCase;

/**
 * App\Controller\Admin\DepositsController Test Case
 *
 * @uses \App\Controller\Admin\DepositsController
 */
class DepositsControllerTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        /** @var \App\Model\Table\DepositsTable $Deposits */
        $this->Deposits = $this->getTableLocator()->get('Deposits', $deposits_config);
    ...
    public function testDelete(): void
    {
        ...
        $this->get('/admin/deposits/delete/1');
        $this->assertResponseCode(302);
        $this->assertHeaderContains('location', '/admin/auth/login');
